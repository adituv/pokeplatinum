...
typedef struct {
    ...
    UnkStruct_0205AA50 unk_4DC;
    UnkStruct_0205AA50 unk_4EC;
    UnkStruct_0205AA50 unk_4FC;
    int unk_50C;
    int unk_510;
    u32 unk_514[14580];
...
static void ov97_02233DD0 (UnkStruct_ov97_02234A2C * param0, UnkStruct_ov97_02233DAC * param1, int param2)
{
    ...
    if (param1->unk_00->unk_00 == NULL) {
        sub_0201A7E8(param0->unk_20, param1->unk_00, param1->unk_24, param1->unk_08, param1->unk_0C, param1->unk_10, param1->unk_14, 15, param1->unk_20);
    }

    if (!(param2 & 0x2)) {
        sub_0201ADA4(param1->unk_00, param1->unk_30);
    }
    ...
    if (param2 & 0x8) {
        if (param2 & 0x10) {
            ...
            sub_0200DC48(param1->unk_00, 0, 0x3F0, 14);
        }
    }
}
    ...
    for (v2 = 0; v2 < 5; v2++) {
        for (v1 = 0; v1 < 6; v1++) {
            ...
            if (param0->unk_20C[v0].unk_00 == NULL) {
                param0->unk_20C[v0].unk_00 = sub_02021AA0(&v3);
            }

            sub_02021CC8(param0->unk_20C[v0].unk_00, 1);
            sub_02021D6C(param0->unk_20C[v0].unk_00, 10 + v0);
            ...
            if (param0->unk_20C[v0].unk_04 == NULL) {
                param0->unk_20C[v0].unk_04 = sub_02021AA0(&v3);
            }

            sub_02021CC8(param0->unk_20C[v0].unk_04, 1);
            sub_02021D6C(param0->unk_20C[v0].unk_04, 40);
...
static void ov97_02234D28 (UnkStruct_02018340 * param0)
{
    {
...
static void ov97_02234F88 (UnkStruct_ov97_02234A2C * param0)
{
    ...
    for (v0 = 0; v0 < 6; v0++) {
        ...
        param0->unk_478[v0] = sub_02021AA0(&v5);

        sub_02021CC8(param0->unk_478[v0], 1);
        sub_02021D6C(param0->unk_478[v0], 10 + v0);
...
static void ov97_02235158 (UnkStruct_0205AA50 * param0)
{
    if (param0->unk_00) {
...
static BOOL ov97_022354C4 (UnkStruct_ov97_02234A2C * param0, int param1)
{
    if (param0->unk_04) {
        ...
        if (sub_0201D724(param0->unk_490.unk_48) == 0) {
            sub_02002B20(0);
            return 1;
        }
    }
...
static BOOL ov97_02235590 (UnkStruct_ov97_02234A2C * param0, int param1)
{
    if (param0->unk_08 != -1) {
        ...
        if (param1) {
            ...
            if (Unk_021BF67C.unk_60 || Unk_021BF67C.unk_48) {
                sub_02002B20(0);
                sub_02005748(1500);
                return 1;
            }
